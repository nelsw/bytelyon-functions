...
var browserTypes = []BrowserType{Chromium, Firefox, WebKit}

func RandomBrowserType() BrowserType {
	return browserTypes[rand.Intn(len(browserTypes))]
}

func (b BrowserType) RandomUserAgent() *string {
	var s string
	if len(b.UserAgents()) > 0 {
		s = b.UserAgents()[rand.Intn(len(b.UserAgents()))]
	}
	return &s
}

func (b BrowserType) UserAgents() []string {
	switch b {
	case Chromium:
		return []string{
			...
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3602.191 Safari/537.36",
			...
			"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3285.174 Safari/537.36",
			"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3837.131 Safari/537.36",
			...
			"Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3208.186 Safari/537.36",
	...
	case Firefox:
		return []string{
			...
			"Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.2.4) Gecko/20100413 Firefox/3.6.4 (.NET CLR 3.5.30729)",
			...
			"Mozilla/5.0 (X11; Ubuntu; 7162 ; Linux i686; rv:28.0) Gecko/20100101 Firefox/28.0",
	...
	case WebKit:
		return []string{
			...
			"Mozilla/5.0 (Macintosh; U; PPC Mac OS X 10.5; en-US; rv:1.9.1b3pre) Gecko/20081212",
